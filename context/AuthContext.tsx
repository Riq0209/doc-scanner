...
export const AuthProvider: React.FC<AuthProviderProps> = ({ children }) => {
  ...
  const signInWithGoogle = async () => {
    try {
      ...
      // Create the redirect URI - force Expo Auth Proxy with correct username
      const hardcodedUrl = `https://auth.expo.io/@riqpro/doc-scanner`;
      const autoGeneratedUrl = AuthSession.makeRedirectUri({});
      
      console.log('🔗 Hardcoded Redirect URL:', hardcodedUrl);
      console.log('🔗 Auto-generated Redirect URL:', autoGeneratedUrl);
      console.log('🔗 Platform:', Platform.OS);
      console.log('🔗 Using hardcoded URL for OAuth');
      
      const redirectUrl = hardcodedUrl;
      
      if (Platform.OS === 'web') {
        // Web version - use auth session with proper redirect
        console.log('🌐 Web OAuth - Sending request to Supabase with redirectTo:', redirectUrl);
        ...
        if (data?.url) {
          ...
          console.log('🌐 Expected redirect back to:', redirectUrl);
        ...
        console.log('📱 Mobile OAuth - Sending request to Supabase with redirectTo:', redirectUrl);
  ...
  const resetPassword = async (email: string) => {
    try {
      ...
      const redirectUrl = Platform.OS === 'web' 
        ...
        : 'https://mwbbrilsskueodquxxin.supabase.co/auth/v1/callback';
